...
class TraderAccount {
    ...
    NotifyPeerOpenPosition(peer_ticket, peer_total_orders_open) {
        var _a;
        (_a = this.peer) === null || _a === void 0 ? void 0 : _a.SendData(SyncUtil_1.SyncUtil.NotifyPeerOpenPositionPacket(peer_ticket, peer_total_orders_open, this.broker, this.account_number));
    }
